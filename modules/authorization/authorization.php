		...
		<div class="form-wrapper">
			<section class="main-section authorize-section">
				<div class="autorization-form">
					...
					<div class="title title-2">Авторизация</div>
					...
					<form class="form">
						...
						<div class="box-input">
							...
							<input class="input" name="password" type="password" class="border-style">
				...
				<!-- Image -->
				<img src="/images/authorization_img.jpg" class="image_login"/>
